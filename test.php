            ...
            <table style="width:70rem;border:1px solid black;">
                ...
                <tr>
                    ...
                    <td style="border:1px solid black;">
                        ...
                        ?>
                            ...
                            <div><b>PK <?php echo $transaction_id +1 ?> </b></div>
                        </div>
                        <div class="d-flex">
                ...
                <tr>
                    <td>
                        ...
                        <div class="d-flex">
                            <div style="width:10rem;"><input type="text" class="border-0 name"></div>
                            <div> <input type="text" class="border-0 phone"></div>
                        </div>
                    </td>
                    <td style="border:1px solid black;">
                        <div class="d-flex">
                            <div style="width:10rem;">Transaction Reason</div>
                            <div><b><input type="text" class="border-0 stransaction_reason"></b></div>
                        </div>
                    </td>
                </tr>
                <tr>
                    <td style="border:1px solid black;">
                        <div class="row d-flex">
                            <div class="col-md-12"><b>Occupation</b><br>
                                <input type="text" class="border-0 ooccupation">
                            </div>
                            <div>
                    </td>
                    <td style="border:1px solid black;">
                        ...
                        <div class="d-flex ml-5">
                            <div style="width:5rem;"><b><input type="text" class="border-0 scurrency"></b></div>
                            <div style="width:10rem;">
                                <input type="text" class="border-0 samount">
                            </div>
                        </div>
                    </td>
                ...
                <tr>
                    ...
                    <td style="border:1px solid black;">
                        ...
                        <div class="d-flex ml-5">
                            ...
                            <div style="width:10rem;"><input type="text" class="border-0 sexchange"></div>
                        </div>
                    </td>
                </tr>
                <td style="border:1px solid black;">
                    ...
                    <div class="d-flex">
                        <div style="width:10rem;"><input type="text" class="border-0 sreceiver_name"></div>
                        <div> <input type="text" class="border-0 scontact"></div>
                    </div>
                </td>
                <td style="border:1px solid black;">
                    Amount To Be Transimitted
                    <div class="d-flex ml-5">
                        <div style="width:5rem;"><b><b><input type="text" class="border-0 scurrency"></b></b></div>
                        <div style="width:10rem;"><input type="text" class="border-0 samount"></div>
                    </div>
                </td>
                </tr>
                <tr>
                    <td style="border:1px solid black; margin:2px;"><b>Address</b><br>
                        <textarea class="border-0 address"></textarea>
                    </td>
                    <td style="border:1px solid black;">
                        <div>Total Cash</div>
                        <div class="d-flex ml-5">
                            <div style="width:5rem;"><b>GBP</b></div>
                            <div style="width:10rem;"><input type="text" class="border-0 recv_from_customer"></div>
                        </div>
        </div>
        </td>
        </tr>
